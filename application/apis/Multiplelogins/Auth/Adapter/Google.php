...
class Engine_Api_Multiplelogins_Auth_Adapter_Google implements Zend_Auth_Adapter_Interface
{
   ...
   public function authenticate()
   {
      ...
      if(!array_key_exists('error',$this->_accessToken)) {
         ...
         $result['identity'] = new Engine_Api_Multiplelogins_Auth_Identity_Google($this->_accessToken);
         $result['profile'] = $result['identity']->getApi()->getProfile();
      }
   ...
   public static function getAuthorizationUrl()
   {
      ...
      return Engine_Api_Multiplelogins_OAuth2_Consumer::getAuthorizationUrl($options['google']);
   }
