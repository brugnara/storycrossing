...
class Engine_Api_Multiplelogins_Auth_Identity_Container implements Iterator
{
	...
	public function add(Engine_Api_Multiplelogins_Auth_Identity_Generic $identity)
	{
