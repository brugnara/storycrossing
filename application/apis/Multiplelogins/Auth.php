 ...
 *
 */
class Engine_Api_Multiplelogins_Auth
{
   ...
   public function getStorage()
   {
      if (NULL === $this->_storage) {
         $this->setStorage(new Engine_Api_Multiplelogins_Auth_Storage_MultipleIdentities());
      }
...
//         !is_subclass_of($identity, 'TBS\Auth\Identity\Generic')) {
      if (!($identity instanceof Engine_Api_Multiplelogins_Auth_Identity_Generic)) {
...
//          || get_class($currentIdentity) !== 'TBS\Auth\Identity\Container')
          || !($currentIdentity instanceof Engine_Api_Multiplelogins_Auth_Identity_Container))
      {
         $currentIdentity = new Engine_Api_Multiplelogins_Auth_Identity_Container();
      }
