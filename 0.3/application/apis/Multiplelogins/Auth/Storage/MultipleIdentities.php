...
class Engine_Api_Multiplelogins_Auth_Storage_MultipleIdentities implements Zend_Auth_Storage_Interface
{
...
//        if (get_class($container) !== 'TBS\Auth\Identity\Container') {
        if (!($container instanceof Engine_Api_Multiplelogins_Auth_Identity_Container)) {
