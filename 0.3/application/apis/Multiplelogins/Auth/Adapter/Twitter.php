...
class Engine_Api_Multiplelogins_Auth_Adapter_Twitter implements Zend_Auth_Adapter_Interface
{
    ...
    public function authenticate()
    {
        ...
        $identity = new Engine_Api_Multiplelogins_Auth_Identity_Twitter($this->_accessToken, $this->_options);
